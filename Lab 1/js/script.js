...
function triangle(value1, type1, value2, type2) {
    ...
    if (value1 <= 0 || value2 <= 0) {
        console.log("Дані не можуть бути нижчі за 0. ПЕРЕЧИТАЙ ІНСТРУКЦІЮ!");
        return "failed";
    }
    ...
    switch (getKey(type1, type2)) {
        ...
        case "hypotenuse_leg":
            ...
            if (hypotenuse < leg1) {
                ...
                angle1 = Math.asin(leg1 / hypotenuse);
                angle2 = Math.PI / 2 - angle1;
            }
            break;
    ...
    console.log(`alpha = ${radToDeg(angle2).toFixed(3)}°`);
    console.log(`beta = ${radToDeg(angle1).toFixed(3)}°`);
    return "success";
}
